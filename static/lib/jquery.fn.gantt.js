...
//                    var end_point = window.innerHeight;
                    var col = core.elementFromPoint(e.pageX, leftpanel.offset().top + corrY);
...
//                    var start_point = window.innerWidth;
                    try {
                        var start_point = leftpanel.offset().left + leftpanel.width() - 10;
                        var row = core.elementFromPoint(start_point, e.pageY);
                        ...
                        if(row && row[0].id.indexOf('RowdId') != -1) {
                            settings.onAddClick(e, dt, rowId);
                        }
                    } catch(err) {
                        alert('Can not create record from here !', err);
                    }
                });
                return dataPanel;
            },
